...
export const en: Messages = {
  ...
  mockupTemplateTitles: {
    businessCardEx1: "Startup Business Card",
    businessCardEx2: "Cafe Owner Business Card",
    businessCardEx3: "Design Studio Business Card",
    businessCardEx4: "Law Office Business Card",
    businessCardEx5: "Barbershop Business Card",
    signboardEx1: "Hair Salon Signboard",
    signboardEx2: "Bakery Signboard",
    signboardEx3: "Kids Cafe Signboard",
    signboardEx4: "Bar Signboard",
    signboardEx5: "Traditional Teahouse Signboard",
    mobileAppEx1: "Fitness App",
    mobileAppEx2: "Yoga & Meditation App",
    mobileAppEx3: "Game App",
    mobileAppEx4: "Finance & Investment App",
    mobileAppEx5: "Independent Bookstore App",
    websiteHeroEx1: "IT Startup Website",
    websiteHeroEx2: "Florist Website",
    websiteHeroEx3: "Club & Festival Website",
    websiteHeroEx4: "Hotel Website",
    websiteHeroEx5: "Vintage Boutique Website",
    brochureEx1: "Architecture Firm Brochure",
    brochureEx2: "Management Consulting Brochure",
    brochureEx3: "Kids Art Academy Brochure",
    brochureEx4: "Interior Design Brochure",
    brochureEx5: "Whiskey Bar Brochure",
    brochureEx6: "Fitness Center Brochure",
    posterEx1: "Cafe Poster",
    posterEx2: "Latte Poster",
    posterEx3: "Lemonade Poster",
    posterEx4: "Wine Bar Poster",
    packageEx1: "Skincare Package",
    packageEx2: "Coffee Bean Package",
    packageEx3: "Snack Package",
    packageEx4: "Perfume Package",
    packageEx5: "Handmade Jam Package",
    packageEx6: "Baby Products Package",
    leafletEx1: "Real Estate Agency Leaflet",
    leafletEx2: "Amusement Park Leaflet",
    leafletEx3: "Cafe Drink Menu Leaflet",
    leafletEx4: "Interior Design Leaflet",
    leafletEx5: "Independent Bookstore Leaflet",
    leafletEx6: "Kids Ballet Academy Leaflet",
    bannerEx1: "Office Opening Banner",
    bannerEx2: "Flower Shop Opening Banner",
    bannerEx3: "Festival Promotion Banner",
    bannerEx4: "Gallery Exhibition Banner",
    bannerEx5: "Local Festival Banner",
    bannerEx6: "Kids Cafe Opening Banner",
    uniformEx1: "Cafe Barista Uniform",
    uniformEx2: "Bakery Uniform",
    uniformEx3: "Gym Trainer Uniform",
    uniformEx4: "Fine Dining Uniform",
    uniformEx5: "Barbershop Uniform",
    uniformEx6: "Kids Cafe Staff Uniform",
  },
  privacyPolicy: {
    backToHome: "Home",
