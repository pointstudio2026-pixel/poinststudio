...
export const en: Messages = {
  ...
  mockupTemplateTitles: {
    businessCardEx1: "Minimal Brand Business Card",
    businessCardEx2: "Natural Brand Business Card",
    businessCardEx3: "Bold Color Business Card",
    businessCardEx4: "Luxury Dark Business Card",
    businessCardEx5: "Classic Brand Business Card",
    signboardEx6: "Bicycle Repair Shop Sign",
    mobileAppEx6: "Recipe App",
    websiteHeroEx6: "Photographer Portfolio Website",
    brochureEx7: "Law Firm Brochure",
    posterEx5: "Pet Grooming Salon Poster",
    packageEx7: "Handmade Chocolate Package",
    leafletEx7: "Yoga Studio Leaflet",
    bannerEx7: "Independent Bookstore Banner",
    uniformEx7: "Pharmacy Staff Uniform",
    posterEx6: "Florist Shop Poster",
    signboardEx1: "Coffee Roastery Signboard",
    signboardEx2: "Organic Store Signboard",
    signboardEx3: "Burrito Shop Signboard",
    signboardEx4: "Luxury Boutique Signboard",
    signboardEx5: "Dessert Cafe Signboard",
    mobileAppEx1: "Finance Budgeting App",
    mobileAppEx3: "Creative Community App",
    mobileAppEx4: "Luxury Shopping App",
    mobileAppEx5: "Home Living Shopping App",
    websiteHeroEx1: "IT Startup Website",
    websiteHeroEx2: "SaaS Platform Website",
    websiteHeroEx3: "Tech Startup Website",
    websiteHeroEx4: "Luxury Furniture Brand Website",
    websiteHeroEx5: "Digital Agency Website",
    brochureEx1: "Lifestyle Brand Brochure",
    brochureEx2: "Architecture & Interior Brochure",
    brochureEx3: "Design Studio Brochure",
    brochureEx4: "Wellness Brand Brochure",
    brochureEx5: "Villa Resort Brochure",
    brochureEx6: "AI Tech Company Brochure",
    posterEx1: "Home Living Brand Poster",
    posterEx2: "Lifestyle Brand Poster",
    posterEx3: "Fitness App Poster",
    posterEx4: "Luxury Leather Brand Poster",
    packageEx1: "Plant Protein Powder Package",
    packageEx2: "Herbal Tea Package",
    packageEx3: "Nut Snack Package",
    packageEx4: "Premium Night Herbal Tea Package",
    packageEx5: "Black Tea Package",
    packageEx6: "Collagen Beauty Package",
    leafletEx1: "Natural Skincare Leaflet",
    leafletEx2: "Lifestyle Product Leaflet",
    leafletEx3: "Creative Studio Leaflet",
    leafletEx5: "Bakery Leaflet",
    leafletEx6: "Skincare Brand Leaflet",
    bannerEx1: "Living Lifestyle Brand Banner",
    bannerEx5: "Italian Pizzeria Banner",
    bannerEx6: "Lifestyle Concept Store Banner",
    uniformEx1: "Cafe Barista Uniform",
    uniformEx2: "Hospital Scrub Uniform",
    uniformEx3: "Construction Safety Vest Uniform",
    uniformEx4: "Chef Uniform",
    uniformEx5: "Retail Store Uniform",
    uniformEx6: "Hotel Uniform",
  },
  privacyPolicy: {
    backToHome: "Home",
