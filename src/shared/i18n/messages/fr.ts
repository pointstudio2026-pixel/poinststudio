...
export const fr: Messages = {
  ...
  mockupTemplateTitles: {
    businessCardEx1: "Carte de visite startup",
    businessCardEx2: "Carte de visite propriétaire de café",
    businessCardEx3: "Carte de visite studio de design",
    businessCardEx4: "Carte de visite cabinet d'avocats",
    businessCardEx5: "Carte de visite barbier",
    signboardEx1: "Enseigne salon de coiffure",
    signboardEx2: "Enseigne boulangerie",
    signboardEx3: "Enseigne café pour enfants",
    signboardEx4: "Enseigne de bar",
    signboardEx5: "Enseigne maison de thé traditionnelle",
    mobileAppEx1: "Application fitness",
    mobileAppEx2: "Application yoga et méditation",
    mobileAppEx3: "Application de jeu",
    mobileAppEx4: "Application finance et investissement",
    mobileAppEx5: "Application librairie indépendante",
    websiteHeroEx1: "Site web startup IT",
    websiteHeroEx2: "Site web fleuriste",
    websiteHeroEx3: "Site web club et festival",
    websiteHeroEx4: "Site Web d'Hôtel",
    websiteHeroEx5: "Site Web Boutique Vintage",
    brochureEx1: "Brochure Cabinet d'Architecture",
    brochureEx2: "Brochure Conseil en Gestion",
    brochureEx3: "Brochure École d'Art pour Enfants",
    brochureEx4: "Brochure de Présentation Intérieure",
    brochureEx5: "Brochure Bar à Whisky",
    brochureEx6: "Brochure Centre de Fitness",
    posterEx1: "Affiche de Café",
    posterEx2: "Affiche Latte",
    posterEx3: "Affiche Limonade",
    posterEx4: "Affiche Bar à Vin",
    packageEx1: "Packaging Soins de la Peau",
    packageEx2: "Packaging Café en Grains",
    packageEx3: "Packaging de Snacks",
    packageEx4: "Packaging Parfum",
    packageEx5: "Packaging Confiture Artisanale",
    packageEx6: "Packaging Produits pour Bébé",
    leafletEx1: "Dépliant d'agence immobilière",
    leafletEx2: "Dépliant de parc d'attractions",
    leafletEx3: "Dépliant menu boissons de café",
    leafletEx4: "Dépliant d'aménagement intérieur",
    leafletEx5: "Dépliant de librairie indépendante",
    leafletEx6: "Dépliant école de ballet pour enfants",
    bannerEx1: "Banderole d'ouverture de bureau",
    bannerEx2: "Banderole d'ouverture de fleuriste",
    bannerEx3: "Banderole promotionnelle de festival",
    bannerEx4: "Banderole d'exposition de galerie",
    bannerEx5: "Banderole de fête locale",
    bannerEx6: "Banderole d'ouverture de café pour enfants",
    uniformEx1: "Uniforme de barista de café",
    uniformEx2: "Uniforme de boulangerie",
    uniformEx3: "Uniforme de coach de salle de sport",
    uniformEx4: "Uniforme de restaurant gastronomique",
    uniformEx5: "Uniforme de barbier",
    uniformEx6: "Uniforme du personnel de café pour enfants",
  },
  privacyPolicy: {
    backToHome: "Accueil",
