...
export const fr: Messages = {
  ...
  mockupTemplateTitles: {
    businessCardEx1: "Carte de Visite Minimaliste",
    businessCardEx2: "Carte de Visite Naturelle",
    businessCardEx3: "Carte de Visite Colorée",
    businessCardEx4: "Carte de Visite Luxe Sombre",
    businessCardEx5: "Carte de Visite Classique",
    signboardEx6: "Enseigne d'Atelier de Vélo",
    mobileAppEx6: "Application de Recettes",
    websiteHeroEx6: "Site Portfolio de Photographe",
    brochureEx7: "Brochure de Cabinet d'Avocats",
    posterEx5: "Affiche de Salon de Toilettage",
    packageEx7: "Emballage de Chocolat Artisanal",
    leafletEx7: "Dépliant de Studio de Yoga",
    bannerEx7: "Bannière de Librairie Indépendante",
    uniformEx7: "Uniforme du Personnel de Pharmacie",
    posterEx6: "Affiche de Boutique de Fleuriste",
    signboardEx1: "Enseigne Torréfacteur de Café",
    signboardEx2: "Enseigne Magasin Bio",
    signboardEx3: "Enseigne Restaurant de Burritos",
    signboardEx4: "Enseigne Boutique de Luxe",
    signboardEx5: "Enseigne Café de Desserts",
    mobileAppEx1: "Application de Budget Personnel",
    mobileAppEx3: "Application Communauté Créative",
    mobileAppEx4: "Application Shopping de Luxe",
    mobileAppEx5: "Application Shopping Maison",
    websiteHeroEx1: "Site Web Startup IT",
    websiteHeroEx2: "Site Web Plateforme SaaS",
    websiteHeroEx3: "Site Web Startup Tech",
    websiteHeroEx4: "Site de Mobilier de Luxe",
    websiteHeroEx5: "Site d'Agence Digitale",
    brochureEx1: "Brochure de Marque Lifestyle",
    brochureEx2: "Brochure Architecture et Décoration",
    brochureEx3: "Brochure de Studio de Design",
    brochureEx4: "Brochure de Marque Bien-être",
    brochureEx5: "Brochure de Villa Resort",
    brochureEx6: "Brochure d'Entreprise Tech IA",
    posterEx1: "Affiche de Marque Home Living",
    posterEx2: "Affiche de Marque Lifestyle",
    posterEx3: "Affiche d'Application Fitness",
    posterEx4: "Affiche de Marque de Cuir de Luxe",
    packageEx1: "Emballage de Protéine Végétale en Poudre",
    packageEx2: "Emballage de Thé aux Herbes",
    packageEx3: "Emballage de Snack aux Noix",
    packageEx4: "Emballage de Thé aux Herbes Premium du Soir",
    packageEx5: "Emballage de Thé Noir",
    packageEx6: "Emballage de Beauté au Collagène",
    leafletEx1: "Dépliant Soins Naturels",
    leafletEx2: "Dépliant Produits Lifestyle",
    leafletEx3: "Dépliant Studio Créatif",
    leafletEx5: "Dépliant Boulangerie",
    leafletEx6: "Dépliant Marque de Soins",
    bannerEx1: "Bannière Marque Maison & Lifestyle",
    bannerEx5: "Bannière Pizzeria Italienne",
    bannerEx6: "Bannière Concept Store Lifestyle",
    uniformEx1: "Uniforme Barista de Café",
    uniformEx2: "Uniforme Médical (Blouse de Bloc)",
    uniformEx3: "Gilet de Sécurité de Chantier",
    uniformEx4: "Uniforme de Chef",
    uniformEx5: "Uniforme de Boutique",
    uniformEx6: "Uniforme d'Hôtel",
  },
  privacyPolicy: {
    backToHome: "Accueil",
