  ...
  return (
    <div ref={ref} className="relative">
      <button
        type="button"
        onClick={() => setOpen((v) => !v)}
        className="flex items-center gap-1 whitespace-nowrap rounded-full border-2 border-ink bg-paper px-2.5 py-1 text-xs font-medium text-ink transition hover:bg-ink hover:text-paper"
        aria-expanded={open}
        aria-label="Language"
      >
        ...
        <svg width="9" height="9" viewBox="0 0 10 10" fill="none" stroke="currentColor" strokeWidth="1.6" className="flex-shrink-0">
