        ...
        <p className="text-xs text-muted">
          {promoteError
            ...
            : promoteResult
              ...
              : "매일 자동으로도 실행됩니다. 실사용자 생성물 중 아직 평가 안 된 것들을 사용자가 남긴 좋아요/아쉬워요 평가로 채점해, 80점 이상은 참고자료로 60점 미만은 회피자료로 반영합니다. 평가를 남기지 않은 결과물은 보통 점수로 처리돼 DB에 쌓이지 않고, 60~79점(애매한 평가)도 저장하지 않습니다."}
        </p>
      </div>
